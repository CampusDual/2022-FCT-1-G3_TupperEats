...
import { DialogService, OTableCellRendererServiceComponent, ServiceResponse, ServiceUtils, Util } from 'ontimize-web-ngx';
    ...
    this.dataService[this.queryMethod](filter, this.colArray, this.entity)
      .subscribe((resp: ServiceResponse) => {
        if (resp.isSuccessful()) {
          this.responseMap[cellvalue] = {menu_name :resp.data[0]["menu_name"] , photo_alergenos:resp.data[0]["photo_alergenos"]};
